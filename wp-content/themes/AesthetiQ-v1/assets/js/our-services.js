                ...
                if (arr[index].services) {
                    for (var x = 0; x < arr[index].services.length; x++) {
                        ...
                        div +=
                            ...
                            `<img class="img-fluid d-inline-block mr-2 rounded" style="width: 50px; height: 50px;" src="${serviceThumbnail}">` +
            ...
            if (res.services) {
                for (var x = 0; x < res.services.length; x++) {
                    ...
                    div +=
                        ...
                        `<div class="d-flex justify-content-start">` +
                        `<img class="img-fluid d-inline-block mr-2 rounded" style="width: 50px; height: 50px;" src="${serviceThumbnailUrl}">` +
